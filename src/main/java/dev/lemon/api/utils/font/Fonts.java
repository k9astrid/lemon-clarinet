...
public abstract class Fonts {
    ...
    public static final CFontRenderer BOLD_18 = new CFontRenderer(Fonts.getFonts("Volte-Semibold.ttf", 18), true, true);
    public static final CFontRenderer BOLD_17 = new CFontRenderer(Fonts.getFonts("Volte-Semibold.ttf", 17), true, true);
    public static final CFontRenderer BOLD_15 = new CFontRenderer(Fonts.getFonts("Volte-Semibold.ttf", 15), true, true);
    public static final CFontRenderer BOLD_12 = new CFontRenderer(Fonts.getFonts("Volte-Semibold.ttf", 12), true, true);
