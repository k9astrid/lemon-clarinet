...
import mc.clpz.base.event.impl.game.WorldLoadEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        BaseClient.INSTANCE.startClient();
    ...
    private void clickMouse() {
        BaseClient.INSTANCE.getEventBus().dispatch(new ClickMouseEvent());
    ...
    public void runTick() throws IOException {
        BaseClient.INSTANCE.getEventBus().dispatch(new TickEvent());
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                ...
                if (Mouse.getEventButtonState()) {
                    ...
                    BaseClient.INSTANCE.getEventBus().dispatch(eventMouse);
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    BaseClient.INSTANCE.getEventBus().dispatch(new KeyInputEvent(k));
                    KeyBinding.onTick(k);
                }
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        if (worldClientIn != null) {
            ...
            BaseClient.INSTANCE.getEventBus().dispatch(eventWorldLoad);
        } else {
