...
import mc.clpz.base.event.impl.game.ChatEvent;
import mc.clpz.base.event.impl.player.MotionEvent;
import mc.clpz.base.event.impl.player.PushEvent;
import mc.clpz.base.event.impl.player.SlowdownEvent;
import mc.clpz.base.event.impl.player.UpdateEvent;
import mc.clpz.base.event.impl.render.InsideBlockRenderEvent;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                BaseClient.INSTANCE.getEventBus().dispatch(updateEvent);
                if (updateEvent.isCanceled()) {
                    BaseClient.INSTANCE.getEventBus().dispatch(new UpdateEvent(this.rotationYaw, this.rotationPitch, this.getEntityBoundingBox().minY, this.onGround));
                    return;
                }
    ...
    public void sendChatMessage(String message) {
        ...
        BaseClient.INSTANCE.getEventBus().dispatch(chatEvent);
    ...
    public boolean isEntityInsideOpaqueBlock() {
        ...
        BaseClient.INSTANCE.getEventBus().dispatch(insideBlockRenderEvent);
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        BaseClient.INSTANCE.getEventBus().dispatch(ep);
        if (this.noClip || ep.isCanceled()) {
            ...
            BaseClient.INSTANCE.getEventBus().dispatch(epo);
            return false;
        }
    }
