...
public class Main
{
    public static void main(String[] p_main_0_)
    {
        ...
        OptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo("Player" + Minecraft.getSystemTime() % 1000L, new String[0]); //smth wrong with this (it wont launch)
