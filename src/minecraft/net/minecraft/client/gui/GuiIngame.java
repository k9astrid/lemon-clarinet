...
import mc.clpz.base.event.impl.render.CrosshairEvent;
import mc.clpz.base.event.impl.render.Render2DEvent;
import mc.clpz.base.module.Module;
import mc.clpz.base.module.impl.other.AutoMatchJoin;
...
public class GuiIngame extends Gui {
    ...
    protected boolean showCrosshair() {
        ...
        BaseClient.INSTANCE.getEventBus().dispatch(crosshairEvent);
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
        final HUD hud = (HUD) BaseClient.INSTANCE.getModuleManager().getModule("hud");
        ...
        float y1 = 24;
        for (Module mod : BaseClient.INSTANCE.getModuleManager().getModuleMap().values()) {
        ...
        for (Object score1 : arraylist1) {
            ...
            AutoMatchJoin autoMatchJoin = (AutoMatchJoin) BaseClient.INSTANCE.getModuleManager().getModule("AutoMatchJoin");
