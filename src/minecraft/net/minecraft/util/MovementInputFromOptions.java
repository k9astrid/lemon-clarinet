...
import mc.clpz.base.module.impl.movement.Scaffold;
...
public class MovementInputFromOptions extends MovementInput {
    ...
    public void updatePlayerMoveState() {
        if (BaseClient.INSTANCE.getModuleManager().getModule("invwalk").isEnabled() && !(Minecraft.getMinecraft().currentScreen instanceof GuiChat)) {
            ...
            final Scaffold scaffold = (Scaffold) BaseClient.INSTANCE.getModuleManager().getModule("scaffold");
