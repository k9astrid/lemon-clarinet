 package dev.lemon.recode.utils.impl.render;
...
public class ColorUtil {
    ...
    public static int LemonRecodeColors(float seconds, long index) {
        index += 40;
        ...
        return getGradientOffset(new Color(255, 247, 0), new Color(255, 250, 205), hue2).getRGB();
    }
