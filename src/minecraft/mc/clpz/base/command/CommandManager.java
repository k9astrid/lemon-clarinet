...
import mc.clpz.base.command.impl.*;
...
import mc.clpz.base.utils.value.impl.StringValue;
...
public class CommandManager {
    ...
    public void dispatch(final String s) {
        ...
        if (command.length > 1) {
            Module m = BaseClient.INSTANCE.getModuleManager().getModule(command[0]);
            if (m != null) {
        ...
        BaseClient.INSTANCE.getCommandManager().getCommandMap().values().forEach(c -> {
