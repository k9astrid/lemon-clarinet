package mc.clpz.base.notification;
...
public class Notification {
    ...
    public void draw(float prevY) {
        HUD hud = (HUD) BaseClient.INSTANCE.getModuleManager().getModule("hud");
        ...
        if (delete()) BaseClient.INSTANCE.getNotificationManager().getNotifications().remove(this);
    }
