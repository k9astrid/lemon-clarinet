package mc.clpz.base;

import net.minecraft.client.Minecraft;

import java.io.File;

import mc.clpz.base.arraylist.ArrayListManager;
import mc.clpz.base.command.CommandManager;
import mc.clpz.base.config.ConfigManager;
import mc.clpz.base.event.bus.EventBus;
import mc.clpz.base.friend.FriendManager;
import mc.clpz.base.gui.account.system.AccountManager;
import mc.clpz.base.macro.MacroManager;
import mc.clpz.base.module.ModuleManager;
import mc.clpz.base.notification.NotificationManager;
import mc.clpz.base.utils.thealtening.AltService;
import mc.clpz.base.waypoint.WaypointManager;
...
public enum BaseClient {
    ...
    public void startClient() {
        dir = new File(Minecraft.getMinecraft().mcDataDir,"Base Client");
