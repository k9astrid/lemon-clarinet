...
import mc.clpz.base.gui.tab.component.impl.CategoryComponent;
    ...
    public void onKeyPress(int key) {
        ...
        switch (key) {
            ...
            case Keyboard.KEY_RIGHT:
                if (!isExtendedModule() && !isExtendedValue() && !BaseClient.INSTANCE.getModuleManager().getModulesInCategory(selectedCategory).isEmpty()) setExtendedModule(true);
                break;
            default:
                break;
        }
