package mc.clpz.base.gui.clickgui.frames.impl;

import net.minecraft.client.Minecraft;
import org.apache.commons.lang3.StringUtils;

import mc.clpz.base.BaseClient;
import mc.clpz.base.gui.clickgui.components.Component;
import mc.clpz.base.gui.clickgui.components.impl.ModuleComponent;
import mc.clpz.base.gui.clickgui.frames.Frame;
...
public class CategoryFrame extends Frame {
    ...
    public void init() {
        ...
        final ArrayList<Module> mods = BaseClient.INSTANCE.getModuleManager().getModulesInCategory(category);
