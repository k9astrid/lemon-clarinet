package mc.clpz.base.gui.account.gui;
...
import mc.clpz.base.gui.account.gui.components.GuiAccountList;
import mc.clpz.base.gui.account.gui.impl.GuiAddAlt;
import mc.clpz.base.gui.account.gui.impl.GuiAltLogin;
...
public class GuiAltManager extends GuiScreen {
    ...
    public void drawScreen(int p_drawScreen_1_, int p_drawScreen_2_, float p_drawScreen_3_){
        ...
        drawCenteredString(mc.fontRendererObj, "Accounts: " + BaseClient.INSTANCE.getAccountManager().getAccounts().size(), width / 2, 15, 0xFFFFFFFF);
    }
        ...
        switch (button.id) {
            ...
            case 8:
                if(BaseClient.INSTANCE.getAccountManager().getLastAlt() == null)
                    return;
                loginThread = new AccountLoginThread(BaseClient.INSTANCE.getAccountManager().getLastAlt().getEmail(),BaseClient.INSTANCE.getAccountManager().getLastAlt().getPassword());
                loginThread.start();
                break;
            case 9:
