package mc.clpz.base.gui.materialui.plane.impl;
...
import mc.clpz.base.gui.materialui.component.Component;
import mc.clpz.base.gui.materialui.component.impl.CategoryComponent;
import mc.clpz.base.gui.materialui.plane.Plane;
import mc.clpz.base.module.Module;
import mc.clpz.base.utils.MouseUtil;
...
public class MainPlane extends Plane {
    ...
    public void onDrawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Fonts.clickGuiTitleFont.drawStringWithShadow(StringUtils.capitalize(getSelectedCategory().name().toLowerCase()) + " (" + BaseClient.INSTANCE.getModuleManager().getModulesInCategory(getSelectedCategory()).size() + ")", getPosX() + 45, getPosY() + 24, new Color(229, 229, 223, 255).getRGB());
