...
import mc.clpz.base.utils.value.impl.RangedValue;
...
public class KillAura extends Module {
    ...
    public void onUpdate(UpdateEvent event) {
        final Criticals criticals = (Criticals) BaseClient.INSTANCE.getModuleManager().getModule("criticals");
    ...
    private boolean canCrit() {
        return getMc().thePlayer.onGround && !BaseClient.INSTANCE.getModuleManager().getModule("speed").isEnabled() && !getMc().gameSettings.keyBindJump.isKeyDown() && getMc().thePlayer.fallDistance == 0;
    }
