...
import mc.clpz.base.event.impl.player.StepEvent;
...
public class Step extends Module {
    ...
    public void onStep(StepEvent event) {
        if (getMc().theWorld == null || getMc().thePlayer == null || BaseClient.INSTANCE.getModuleManager().getModule("speed").isEnabled() || BaseClient.INSTANCE.getModuleManager().getModule("flight").isEnabled() || BaseClient.INSTANCE.getModuleManager().getModule("longjump").isEnabled())
            return;
