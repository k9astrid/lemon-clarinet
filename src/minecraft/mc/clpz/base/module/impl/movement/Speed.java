...
import mc.clpz.base.utils.MoveUtil;
...
public class Speed extends Module {
                ...
                switch (stage) {
                    ...
                    case 2:
                        ...
                        if ((getMc().thePlayer.moveForward != 0.0F || getMc().thePlayer.moveStrafing != 0.0F) && getMc().thePlayer.onGround) {
                            ...
                            if (!BaseClient.INSTANCE.getModuleManager().getModule("scaffold").isEnabled()) {
                        ...
                        break;
                    case 3:
                        double boost = BaseClient.INSTANCE.getModuleManager().getModule("scaffold").isEnabled() ? 0.725 : (getMc().thePlayer.isPotionActive(Potion.moveSpeed) ? (getMc().thePlayer.isPotionActive(Potion.jump) ? 0.915f : 0.725f) :
                                0.71625f);
    ...
    private void setMoveSpeed(final MotionEvent event, final double speed) {
        ...
        boolean shouldStrafe = BaseClient.INSTANCE.getModuleManager().getModule("targetstrafe").isEnabled() && TargetStrafe.indexPos != null && TargetStrafe.target != null && !(!getMc().gameSettings.keyBindJump.isKeyDown() && TargetStrafe.spaceOnly.isEnabled());
