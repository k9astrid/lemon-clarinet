...
public class ConfigManager {
    ...
    public void deleteConfig(String cfgname) {
        ...
        BaseClient.INSTANCE.getConfigManager().getConfigs().remove(getConfig(cfgname));
    }
    ...
    public void saveConfig(String cfgname, boolean key) {
        ...
        BaseClient.INSTANCE.getModuleManager().getModuleMap().values().forEach(module -> {
    ...
    public void loadConfig(String cfgname) {
        ...
        try {
            ...
            arr.forEach(element -> {
                ...
                Module m = BaseClient.INSTANCE.getModuleManager().getModule(name);
                if (m != null) {
                    m.load(subobj);
                }
            });
